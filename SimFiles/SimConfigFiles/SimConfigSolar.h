...
//-------------------------------------------SOLAR--------------------------------------
//--------------------------------------------------------------------------------------
#define SOLAR_TEST_USE_ETERNAL_SUNSHINE 1       // stationary satellite only in sunlight
#define SOLAR_TEST_USE_ETERNAL_DARKNESS 0       // stationary satellite only in darkness
...
#define SOLAR_NUM_OF_SOLAR_PANELS_FACING_THE_SUN 2
